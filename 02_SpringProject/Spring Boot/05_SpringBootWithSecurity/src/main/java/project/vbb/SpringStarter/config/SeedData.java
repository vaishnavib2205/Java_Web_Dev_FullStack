...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        account01.setPassword(passwordEncoder.encode("password"));  // Encode password
        account01.setFirstname("user01");
        account01.setLastName("lastName");
        account01.setRole(Roles.USER);  // Set role as enum

        account02.setEmail("admin@admin.com");
        account02.setPassword(passwordEncoder.encode("password"));  // Encode password
        account02.setFirstname("Admin");
        account02.setLastName("lastName");
        account02.setRole(Roles.ADMIN);  // Set role as enum

        account03.setEmail("editor@editor.com");
        account03.setPassword(passwordEncoder.encode("password"));  // Encode password
        ...
        account04.setPassword(passwordEncoder.encode("pass987"));  // Encode password
